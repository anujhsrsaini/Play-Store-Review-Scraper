  ...
  return (
    <div className="py-6 text-center">
      <h1 className="text-2xl font-semibold text-slate-900 sm:text-3xl">
        Ask anything about an app's reviews
      </h1>
      <p className="mx-auto mt-2 max-w-xl text-slate-500">
        Grounded, cited answers from real Google Play reviews — complaints, praise, feature
        requests, sentiment. Search any app to start.
      </p>
    </div>
  );
}
...
function SignInGate() {
  return (
    <Card className="mx-auto mt-10 max-w-md p-8 text-center">
      <h1 className="text-xl font-semibold text-slate-900">Review Lens</h1>
      <p className="mt-2 text-sm text-slate-500">
        Sign in to analyze any Google Play app's reviews. Free, with a daily limit.
      </p>
      <a href="/auth/login" className="mt-5 inline-block">
