    ...
    <header className="sticky top-0 z-20 border-b border-white/10 bg-ink/60 backdrop-blur-xl">
      <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 py-3">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          {me?.is_anon ? (
            // Anonymous trial: inform, then nudge — never block.
            me.remaining > 0 ? (
              <>
                <Badge tone="neutral">
                  <Sparkles className="mr-1 h-3 w-3" /> Free analysis ready
                </Badge>
                <a
                  href="/auth/login"
                  title="5 free analyses a day"
                  className="inline-flex items-center gap-1 text-sm text-slate-400 transition hover:text-white"
                >
                  Sign in
                </a>
              ...
              <>
                <Badge tone="negative">Free analysis used</Badge>
                <a
                  href="/auth/login"
