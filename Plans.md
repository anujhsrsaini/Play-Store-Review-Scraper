...
| 6.7 | **Owner setup (handoff)**: Google OAuth client + redirect URI; subdomain DNS → Ampere IP; Sarvam spend limit/alert. `[tdd:skip:owner-config]` | Documented checklist; values supplied to deploy | - | cc:wip (DEPLOY.md checklist; OAuth creds pending from owner; awaiting DNS + Sarvam spend guard) |
